...
% trigger de eventos
rule: { (0,0) } { ((0,0)!1-time/1000)-(0,0)!0 } { (0,0)!0 < ((0,0)!1 - time/1000)} % agendo un evento para cuando el producto deba abandonar la columna
% rule: { (0,0) } { (0,0)!1-time/1000)!1 } { (0,0)!0 > ((0,0)!1 - time/1000)}
