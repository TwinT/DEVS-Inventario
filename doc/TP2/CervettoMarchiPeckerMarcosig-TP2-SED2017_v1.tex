...
\begin{enumerate}
	...
	\item Si el producto se moveró a la derecha, en el mismo instante la celda se setea en 0
...
\begin{enumerate}
	...
	\item La celda se setea en 0 en el mismo instante que el despachante se movió una posición hacia la izquierda (i.e. (0,-1)=[-1,0])
\end{enumerate}
