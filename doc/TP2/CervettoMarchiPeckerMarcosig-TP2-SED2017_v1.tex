...
Para cada celda en este autómata celular interesa el valor de las $6$ celdas alrededor. Por este motivo el vecindario está definido en la Figura~\ref{fig:IP-vecindario}.
