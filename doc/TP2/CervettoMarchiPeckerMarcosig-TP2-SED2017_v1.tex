...
En la Figura~\ref{fig:IP-movimiento} se puede observar el movimiento lateral y hacia abajo de un producto. Este movimiento se debe a que de acuerdo a su fecha de vencimiento el producto se debe ubicar en una columna de rangos de fecha de vencimiento más próxima y lo más cerca de la fila inferior posible.

 \begin{figure}[h] 
 \centering
 	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[width=0.6\linewidth]{00_05_19_800}
		\caption{t = 00:05:19:800}
		\label{fig:IP-movimiento-a}
	\end{subfigure}
 	\begin{subfigure}{0.5\textwidth}
		\centering
 		\includegraphics[width=0.6\linewidth]{00_05_19_900}
		\caption{t = 00:05:19:900}
		\label{fig:IP-movimiento-b}
	\end{subfigure}
 	\begin{subfigure}{0.5\textwidth}
		\centering
 		\includegraphics[width=0.6\linewidth]{00_05_20_000}
		\caption{t = 00:05:20:000}
		\label{fig:IP-movimiento-c}
	\end{subfigure}
 	\begin{subfigure}{0.5\textwidth}
		\centering
 		\includegraphics[width=0.6\linewidth]{00_05_20_100}
		\caption{t = 00:05:20:100}
...
En la Figura~\ref{fig:IP-ensayodisputa} se puede observar el comportamiento del inventario ante una situación de disputa. Se puede ver que la fecha de venciminto del producto que está encima de la celda vacía es menor que la de la celda a la derecha de la misma. Por este motiva, la primera gana la disputa y el producto baja ocupando la celda vacía.
 ...
 \centering
 	\begin{subfigure}{0.5\textwidth}
		\centering
 		\includegraphics[width=0.6\linewidth]{00_20_00_001}
		\caption{t = 00:05:19:800}
		\label{fig:IP-ensayodisputa-a}
	\end{subfigure}
 	\begin{subfigure}{0.5\textwidth}
		\centering
 		\includegraphics[width=0.6\linewidth]{00_20_00_101}
		\caption{t = 00:05:19:900}
		\label{fig:IP-ensayodisputa-b}
	\end{subfigure}
 	\begin{subfigure}{0.5\textwidth}
		\centering
 		\includegraphics[width=0.6\linewidth]{00_20_00_201}
		\caption{t = 00:05:20:000}
		\label{fig:IP-ensayodisputa-c}
	\end{subfigure}
 	\begin{subfigure}{0.5\textwidth}
		\centering
 		\includegraphics[width=0.6\linewidth]{00_20_00_301}
		\caption{t = 00:05:20:100}
