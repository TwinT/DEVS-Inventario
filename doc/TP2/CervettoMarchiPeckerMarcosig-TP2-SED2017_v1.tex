...
Este conjunto de reglas con la estructura graficada en la figura definen el modelo del despacho. Los links y la asignación de reglas se pueden ver en la siguiente definición dentro del archivo ".ma"
