...
A continuación se muestran las los gráficos de evolución de tamaño del inventario, costo de reposición y cantidad de encargos para un parámetro $n=50$ (política de reposición).
...
Como siguiente análisis se procedió a disminuir la política de reposición a $n=10$, con el objeto de evaluar la evolución de los parámetros anteriores. Se espera que el costo baje si el inventario está sobredimensionado o que se produzca una mayor cantidad de encargos si por el contrario estaba subdimensionado.
...
\end{figure}
\FloatBarrier
Se observa que el costo por reposición se torna mucho más inestable, aumentando levemente en promedio. También se observa un aumento de la cantidad de encargos como así también una mayor variabilidad de la cantidad de productos en el inventario.
